import{_ as n,z as s,D as a,W as t}from"./plugin-vue_export-helper.edc68748.js";const g='{"title":"\u5B57\u7B26\u4E32 #","description":"","frontmatter":{},"headers":[],"relativePath":"leetcode/day3.md","lastUpdated":1709106039882}',p={},o=t(`<h1 id="\u5B57\u7B26\u4E32" tabindex="-1">\u5B57\u7B26\u4E32 <a class="header-anchor" href="#\u5B57\u7B26\u4E32" aria-hidden="true">#</a></h1><p><strong>1. \u5251\u6307 Offer 05. \u66FF\u6362\u7A7A\u683C(easy)</strong></p><div class="language-javascript"><pre><code><span class="token comment">// \u8BF7\u5B9E\u73B0\u4E00\u4E2A\u51FD\u6570\uFF0C\u628A\u5B57\u7B26\u4E32 s \u4E2D\u7684\u6BCF\u4E2A\u7A7A\u683C\u66FF\u6362\u6210&quot;%20&quot;\u3002</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div>`,5),e=[o];function c(u,l,r,k,i,d){return a(),s("div",null,e)}var f=n(p,[["render",c]]);export{g as __pageData,f as default};
